            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4>Edit Peserta</h4>
                        <a href="{{ route('reservasi.store') }}" class="btn btn-secondary">Kembali</a>
                    </div>
                        ...
                        <form action="{{ route('reservasi.update', $reservasi->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_pelanggan') is-invalid @enderror"
                                    id="nama_pelanggan" name="nama_pelanggan" value="{{ old('nama_pelanggan', $reservasi->nama_pelanggan) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="int" class="form-control @error('nomor_meja') is-invalid @enderror" id="nomor_meja"
                                    name="nomor_meja" value="{{ old('nomor_meja', $reservasi->nomor_meja) }}" required>
                                @error('nomor_meja')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="int" class="form-control @error('jumlah_orang') is-invalid @enderror"
                                    id="jumlah_orang" name="jumlah_orang" value="{{ old('jumlah_orang', $reservasi->jumlah_orang) }}" required>
                                @error('jumlah_orang')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control @error('tanggal_reservasi') is-invalid @enderror"
                                    id="tanggal_reservasi" name="tanggal_reservasi" value="{{ old('tanggal_reservasi', $reservasi->tanggal_reservasi) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="time" class="form-control @error('waktu_reservasi') is-invalid @enderror"
                                    id="waktu_reservasi" name="waktu_reservasi" value="{{ old('waktu_reservasi', $reservasi->waktu_reservasi) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('catatan_khusus') is-invalid @enderror"
                                    id="catatan_khusus" name="catatan_khusus" value="{{ old('catatan_khusus', $reservasi->catatan_khusus) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('status') is-invalid @enderror"
                                    ...
                                    <option value="terjadwal" {{ old('status', $reservasi->status) == 'terjadwal' ? 'selected' : '' }}>Terdaftar</option>
                                    <option value="hadir" {{ old('status', $reservasi->status) == 'hadir' ? 'selected' : '' }}>Aktif</option>
                                    <option value="dibatalkan" {{ old('status', $reservasi->status) == 'dibatalkan' ? 'selected' : '' }}>Selesai</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
